...
from fused_if_snn import build_fused_if_vgg16
...
def categorize(k):
    if "_fused_if" in k:
        return "FusedIF (hand-written Triton)"
...
model = build_fused_if_vgg16(1000)
...
# 同时落盘
with open(OUT / "fused_if_eager_kernels.txt", "w") as f:
